      ...
      <div className="relative p-4 md:p-5 h-full flex flex-col justify-between">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <span className="font-outfit text-[10px] md:text-xs font-600 text-white/70 uppercase tracking-wide">
              {match.league}
            </span>
            {isLive && (
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between gap-3 group/team">
            <div className="flex items-center gap-2 flex-1 min-w-0">
              <span className="text-2xl md:text-3xl team-logo">{match.homeTeam.logo}</span>
          ...
          <div className="flex items-center justify-between gap-3 group/team">
            <div className="flex items-center gap-2 flex-1 min-w-0">
              <span className="text-2xl md:text-3xl team-logo">{match.awayTeam.logo}</span>
              <div className="min-w-0">
                <p className="font-outfit text-sm md:text-base font-600 text-white truncate group-hover/team:text-red-400 transition-colors">
        ...
        <div className="pt-4 border-t border-white/10 space-y-2">
          <div className="flex items-center gap-2 text-[10px] text-white/50">
            ...
            <span className="font-outfit">
              {isLive ? `${match.minute}' Live` : `Starts at ${match.kickoff}`}
            </span>
          </div>
          <div className="flex items-center gap-2 text-[10px] text-white/50">
            <Users size={12} />
            <span className="font-outfit">{match.viewers} viewers</span>
          </div>
        </div>
