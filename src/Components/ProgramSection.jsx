...
const programs = [
  {
    time: "06:00",
    title: "LA MATINALE DES SPORT",
    category: "Programme",
    duration: "2h",
    live: false,
    image: "https://res.cloudinary.com/drzoiigek/image/upload/v1774432658/mgm7z6stvgqkkuodnisp.png",
    description: "Start your day with the latest sports headlines and overnight results from around the globe.",
  },
  {
    time: "10:15",
    title: "A L'INTERNATIONALE",
    category: "News",
    duration: "1h30",
    live: false,
    image: "https://res.cloudinary.com/drzoiigek/image/upload/v1774432660/xczz6p0w7sblmszsaycs.png",
    description: "All the goals, talking points and top moments from the latest Premier League matchday.",
  },
  {
    time: "10:30",
    title: "LE CLUB",
    ...
    description: "Live coverage from the All England Club as the world's best compete on the grass courts.",
  },
  {
    time: "15:00",
    title: "PELOUSE",
    ...
    description: "Expert analysis and predictions ahead of tonight's critical NBA playoff encounters.",
  },
  {
    time: "17:00",
    title: "FIGHTER",
    ...
    duration: "52 min",
    live: false,
    image: "https://res.cloudinary.com/drzoiigek/image/upload/v1774432657/avhzevinyw0wcb9xgedx.png",
    description: "A comprehensive midday roundup of transfer news, press conferences and injury updates.",
  },
  {
    time: "18:00",
    title: "JTA",
    ...
    duration: "20 min",
    live: false,
    image: "https://res.cloudinary.com/drzoiigek/image/upload/v1774435638/pb6ew7wltjzms6auybuk.jpg",
    description: "El Clásico — the biggest club match in world football, live from the Santiago Bernabéu.",
  },
  {
    time: "19:00",
    title: "JTF",
    ...
    description: "The Cairo Derby takes centre stage in the CAF Champions League semi-final first leg.",
  },
  {
    time: "20:00",
    title: "FEMME ET SPORT",
    category: "Magazine",
    duration: "60 min",
    live: false,
    image: "https://res.cloudinary.com/drzoiigek/image/upload/v1774432657/ndpimpbhf50wfnqx6qpy.png",
    description: "Tactical deep-dives and expert opinions on the day's biggest sports stories.",
  },
  {
    time: "20:30",
    title: "SPORT LE MAG",
    ...
    duration: "60 min",
    live: false,
    image: "https://res.cloudinary.com/drzoiigek/image/upload/v1774436072/bjrs10w3kdcgbtoeqflq.png",
    description: "Wind down with the best moments from a full day of live sport on MehHom.",
  },
];
...
function ProgramCard({ prog, index }) {
  ...
  const cat = categoryStyle[prog.category] || "bg-white/10 text-white/50 border-white/10";
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-5 min-w-0 relative z-20">
        ...
        {/* Title */}
        <h3 className={`font-anton text-xl md:text-2xl leading-tight mb-2 transition-colors duration-200 ${hovered ? (isLive ? "text-red-400" : "text-red-400") : "text-white"}`}>
          {prog.title}
        </h3>
      ...
      {/* Hover arrow */}
      <div className={`absolute ${isEven ? "right-5" : "left-5"} top-1/2 -translate-y-1/2 transition-all duration-200 z-20
