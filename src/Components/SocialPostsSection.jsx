          ...
          <div className="relative z-10 px-6 sm:px-8 md:px-12 py-10 md:py-16">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto shrink-0">
                <button className="group flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white px-8 py-3.5 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-red-600/50 transform hover:scale-105">
                  <span className="inline-block w-2 h-2 rounded-full bg-white animate-pulse" />
                  Watch Live Now
                </button>
                <button className="flex items-center justify-center gap-2 border border-slate-600 hover:border-slate-400 text-slate-300 hover:text-white px-8 py-3.5 rounded-xl font-semibold transition-all duration-300 hover:bg-slate-700/50">
                  <Calendar size={18} />
                  View Schedule
                </button>
              </div>
