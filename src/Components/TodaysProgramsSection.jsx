...
const FontImport = () => (
  <style>{`
    ...
    .prog-row {
      animation: slideIn 0.45s cubic-bezier(.22,1,.36,1) both;
    }
...
const programs = [
  { time: "06:00", title: "Morning Sports Desk",         category: "News",       duration: "60 min",  live: false },
  { time: "07:30", title: "Premier League Highlights",   category: "Football",   duration: "45 min",  live: false },
  { time: "09:00", title: "Tennis: Wimbledon Day 3",     category: "Tennis",     duration: "180 min", live: false },
  { time: "12:00", title: "MehHom Midday Report",        category: "News",       duration: "30 min",  live: false },
  { time: "14:00", title: "NBA Playoff Preview",         category: "Basketball", duration: "60 min",  live: false },
  { time: "16:00", title: "La Liga: Real Madrid vs Barca", category: "Football", duration: "120 min", live: false },
  { time: "19:00", title: "CAF CL: Zamalek vs Al Ahly", category: "Football",   duration: "120 min", live: true  },
  { time: "21:30", title: "MehHom Evening Analysis",     category: "Analysis",   duration: "60 min",  live: false },
  { time: "23:00", title: "Late Night Highlights",       category: "Highlights", duration: "60 min",  live: false },
];
...
function ProgramRow({ prog }) {
  ...
  const catStyle = categoryStyle[prog.category] || "bg-white/10 text-white/50 border-white/10";
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h4 className={`font-outfit text-sm font-600 truncate mb-1.5 ${prog.live ? "text-white" : "text-white/80"}`}>
          {prog.title}
        </h4>
        <div className="flex items-center gap-2">
          <span className={`font-outfit text-[10px] font-600 px-2 py-0.5 rounded-full border tracking-wide ${catStyle}`}>
            {prog.category}
          </span>
